...
function copyTextForm(event) {
	...
	if (
		responses.question1 === null ||
		responses.question2 === null ||
		responses.question3 === null ||
		responses.question4 === null ||
		responses.question5 === null ||
		responses.question6 === null ||
		responses.question7 === null ||
		responses.question8 === null ||
		responses.question9 === null ||
		responses.question10 === null ||
		responses.question11 === null ||
		responses.question12 === null ||
		responses.question13 === null ||
		responses.question14 === null ||
		responses.question15 === null /* || responses.pseudo === ""*/
	) {
		alert(
			"Vous n'avez pas rempli toutes les questions.\nVeuillez répondre aux questions avant de copier le texte.",
		)
	} else {
